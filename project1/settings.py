...
SITE_ID = 1 #needed for the sites and flatpages
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, "templates")],   #important to add so that django uses stuff from current working directory!
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
